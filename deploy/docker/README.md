...
| **`developer-profiles/compose.yml`** | Developer profiles: **base**, **lvs**, **alerts**, **search**; plus **incident**, which rides on the `search` compose tag rather than the `dev-profile` helper (see [`dev-profile-incident/README.md`](developer-profiles/dev-profile-incident/README.md)) |
