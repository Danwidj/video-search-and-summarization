...
export async function GET(request: Request, context: { params: Promise<{ videoId: string }> }) {
  try {
    ...
    const fallback: AnalysisReport = {
      ...
      incident_type: typeof incident.type === 'string' ? incident.type : 'road accident',
      description: typeof incident.description === 'string' ? incident.description : 'No summary was recorded.',
      incident_start: typeof incident.start_timestamp === 'string' ? incident.start_timestamp : '0:00',
      incident_end: typeof incident.end_timestamp === 'string' ? incident.end_timestamp : '0:00',
