...
the shared implementation reference (superseded by [`../.docs/action-plan.md`](../.docs/action-plan.md) and [`../.docs/data.md`](../.docs/data.md); legacy plan in [`../.docs/archive/incident-plan-implementation-shared.md`](../.docs/archive/incident-plan-implementation-shared.md)).
